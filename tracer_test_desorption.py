...
filename = 'SDS_desorption_IL-HP-4_Na, Ca, S Ksenia 26.8.2021'
...
result = curve_fit(functions.make_opt(tracer[5:]), cum_vol[5:], tracer[5:], p0=(5, 9, 200, 1680), 
                   bounds=([2, 7, 150, 1680], [20, 10, 300, 2000]))
